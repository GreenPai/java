...
public class ValidationItemControllerV4 {
    ...
    /**
     *  주의사항 : ModelAttribute ItemSaveForm form 을 하게되면
     *  ModelAttribute("ItemSaveForm", form) 으로 저장이 됩니다.
     *  현재 HTML에서 item으로 저장이 되어 있기 때문에 @ModelAttribute("item") 사용
     */
    ...
    public String addItemV2(@Validated @ModelAttribute("item") ItemSaveForm form, BindingResult bindingResult, RedirectAttributes redirectAttributes, Model model) {
        ...
        // 로직을 성공하면 ItemSaveForm이 아닌 Item으로 저장해야 됩니다.
        Item item = new Item();
